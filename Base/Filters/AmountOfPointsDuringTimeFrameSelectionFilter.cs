...
{
    public class AmountOfPointsDuringTimeFrameSelectionFilter : PointFilter
    {
        private readonly TimeSpan _timeFrame;
        private readonly int _pointsRequired;

        public AmountOfPointsDuringTimeFrameSelectionFilter(Window window, TimeSpan timeFrame, int pointsRequired) : base(window)
        {
